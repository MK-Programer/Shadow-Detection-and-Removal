...
folder=r"D:\shadow-removal-master\dataset"

# select random image name
r_img_name = random.choice(os.listdir(folder))
# print the name of the random image 
print(r_img_name)

# concatenate the random image name with the path of the dataset folder
r_img = folder+'\\' + r_img_name


# read an image with shadow...
# and it converts to BGR color space automatically
or_img = cv2.imread(r_img)
